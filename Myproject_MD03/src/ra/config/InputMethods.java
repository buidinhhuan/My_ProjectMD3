...
public class InputMethods {
    ...
    public static final String EMPTY_ALERT = "  không thể để trống! Vui lòng thử lại....";
    public static final String ERROR_NUMBER = "  Vui lòng nhập số nguyên lớn hơn 0";
    public static final String ERROR_USENAME = "  Tên phải lớn hơn 5 kí tự";
    public static final String ERROR_PASS = " Mật khẩu phải lớn hơn 5 kí tự và không chứa khoảng trắng";
